...
/*
       ...
       String xmlUrl = "G:\\MS_Fall_2014\\ASE\\ASEProject\\EMercado\\App_Data\\a.xml";
     //  XmlTextReader reader = new XmlTextReader(xmlUrl);
       /* while (reader.Read())
        ...
        headerCell2.InnerHtml = "<b> Select to See Map </b>";
        ...
        foreach (XmlNode node in MarketNodeList)
        {
               ...
               // CheckBox b1 = new CheckBox();
                ...
                checkCell.InnerHtml = "<input type='checkbox' name='check'" + i + " value='" + s + "'>";
    ...
    public String SearchMarkets(String queryString, String Url, String Key)
    {
        ...
        String path = "G:\\MS_Fall_2014\\ASE\\ASEProject\\EMercado\\App_Data\\a.xml";
