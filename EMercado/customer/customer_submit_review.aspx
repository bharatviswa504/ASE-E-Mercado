<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customer_submit_review.aspx.cs" Inherits="customer_customer_submit_review" %>
...
<script>
    ...
    function insertData() {
        var url = "http://kc-sce-cs551-2.kc.umkc.edu/aspnet_client/Group12/Project/FarmerReview/FarmerReview/Service1.svc/PutFarmerReview/design1/";
        var farmerName = document.getElementById("fname").value;
        var ratings = document.getElementById("rating").value;
        var feedback = document.getElementById("fb").value;
        var targetURL = url + farmerName + "/" + ratings + "/" + feedback;
...
<br />
<br />
<button class="design1">Add Farmer Review</button><br><br>
</nav>
<img src="../images/reviews.png" style="width:304px;height:228px" id="image"/>
<form id="f1" runat="server">
<section>
<div id="design1"><p>
<table border="5" width="30%" class="tab" style="left:80%">
<tr>
<td>
<h1>Add Farmer Review</h1>
</td>
</tr>
<tr>
<td>
<h3>Farmer Name: <input type="text" id="fname" runat="server"/> <br /> <br />
</td>
</tr>
<tr>
<td>
Ratings(1 to 5): <input type="text" id="rating" runat="server"/><br /><br />
</td>
</tr>
<tr>
<td>
Feedback: <textarea rows="5" cols="50" id="fb" runat="server"> </textarea>
</td>
</tr>
<tr>
<td>
<asp:Button class="btn btn-lg btn-primary btn-block" ID="submitreviewbutton" 
                    runat="server" Text="Submit Review" type="submit" onclick="insertData"/>
</td>
</tr>
</table>
</h3>
...
<label id="success" runat="server"></label>
</section>
</form>
<footer>
